...
var ChatUser = React.createClass({
    ...
    render: function () {
        return React.createElement(
            'li',
            { id: 'userLi' + this.state.UserId, onClick: this.addMessageWindow, key: $.guid++, className: 'clearfix' },
...
var MainChat = React.createClass({
    ...
    render: function () {
        return React.createElement(
            ...
            React.createElement("div", { className: 'chat', id: "ChatWindowContainer" })
        );
    }
