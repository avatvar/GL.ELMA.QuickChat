...
var ChatUser = React.createClass({
    ...
    render: function () {
        return React.createElement(
            'button',
            { id: 'userBtn' + this.state.UserId, onClick: this.addMessageWindow, key: $.guid++, className: 'userItem' },
            this.state.UserName
        );
    }
...
var ChatUsers = React.createClass({
    ...
    render: function () {
        ...
        for (; i < this.state.Users.length; i++) {
            ...
            userDivs.push(React.createElement(ChatUser, { key: i, username: user.UserName, userId: user.UserId, currentUser: this.state.CurrentUserId, chathub: this.state.ChatHub }));
        }
...
var MainChat = React.createClass({
    ...
    render: function () {
        return React.createElement(
            "div",
            null,
            React.createElement(ChatUsers, { chathub: this.state.ChatHub }),
